...
import { canCancelOrder, etaMax, formatIQD, getStore, storeName } from '../data/mock'
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        {list.length === 0 ? (
          ...
          list.map((order) => {
            ...
            const etaMaxMin = etaMax(store)
            const etaMin = Math.max(0, etaMaxMin - Math.floor((now - order.createdAt) / 60000))
