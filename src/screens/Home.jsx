        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginTop: 16 }} contentContainerStyle={{ paddingHorizontal: 16 }}>
          {stories.map((s) => {
            ...
            return (
              ...
              >
                {s.image ? (
                  <Image source={src(s.image)} style={{ position: 'absolute', width: '100%', height: '100%' }} />
                ) : null}
                <View style={{ flex: 1, justifyContent: 'flex-end', padding: 10, backgroundColor: 'rgba(0,0,0,0.32)' }}>
