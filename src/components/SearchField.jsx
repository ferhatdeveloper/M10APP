...
import { Mic, ScanBarcode, Search, X } from 'lucide-react-native'
      ...
      {onVoice ? (
        <SoftPress
          ...
          style={{
            ...
            height: 38,
            borderRadius: 19,
            backgroundColor: voiceListening ? colors.red : colors.bg,
            alignItems: 'center',
            justifyContent: 'center',
          }}
        >
          <Mic size={18} color={voiceListening ? '#fff' : colors.muted} />
        </SoftPress>
      ) : null}
      {scanBtn}
    </View>
